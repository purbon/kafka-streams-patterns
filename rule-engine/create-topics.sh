...
# docker exec -it kafka kafka-console-consumer --bootstrap-server kafka:9092 --topic bar --from-beginning --property   print.partition=true --property print.key=true
